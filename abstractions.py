...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # DOMAIN: inputs are a string, a list, a string, a number, and a list
    # RANGE: returns a list containing the inputs, which are a string, a list, a string, a number, and a list
...
def restaurant_name(restaurant):
    ...
    # DOMAIN: A list containing a string, a list, a string, a number, and a list
...
def restaurant_ratings(restaurant):
    ...
    # looks at each element in restaurant reviews and then pulls review_rating of that review 
    # reviews is a list of [restaurant_name, rating] --> [['Soda', 4.5], ['Soda', 4.0]]
    # return [elem[1] for elem in restaurant[4]]
    # make_review returns ['Soda', 4.5]
    # END Question 2.6
